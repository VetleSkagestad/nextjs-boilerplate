...
export default function Homepage() {
  return (
    <div className="hero">
      <img src="/background.png" alt="" className="background-img" />
     ...
     <main style={{
          ...
          <img src="/logo-clean.png" alt="GameDev Syndicate" style={{ height: '300px',  marginLeft: '90px' }} />
          <h1>Join the Syndicate.</h1>
          <p style={{ maxWidth: '40rem', marginTop: '1rem', textAlign: 'left' }}>
            We are a collaborative group of game creators based in the Inland muncipality in Norway. Come join the Syndicate and connect with fellow developers, participate in events and game jams, and level up your skills.
          </p>
          <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            {/* <a href="#contact" className="cta teal">Contact us</a> */}
            <a href="#contact" className="cta teal">
              <span className="material-symbols-rounded" style={{ fontSize: '1.2em' }}>mail</span>
              Contact us
            </a>
            <a href="#docs" className="cta orange">
              <span className="material-symbols-rounded" style={{ fontSize: '1.2em' }}>list</span>
              Read about us
            </a>
          </div>
        </main>
